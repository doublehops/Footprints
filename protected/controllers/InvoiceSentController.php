...
class InvoiceSentController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['InvoiceSent'];
			if($model->save())
	...
	{
		$model=new InvoiceSent('search');
		if(isset($_GET['InvoiceSent']))
			$model->attributes=$_GET['InvoiceSent'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='invoice-sent-form')
		{
